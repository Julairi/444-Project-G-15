...
class WaitCompList extends StatefulWidget {
  oneWaitCompList createState() => oneWaitCompList();
}

class oneWaitCompList extends State<WaitCompList> {
