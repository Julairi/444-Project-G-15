...
class OrderDetails extends StatelessWidget {
  ...
  OrderDetails({required this.order, required this.post, Key? key}) : super(key: key){
                        ...
                        children: [
                          Expanded(
                            ...
                            child: ElevatedButton(
                              onPressed: () => showRejectDialog(context, controller),
                          ...
                          Expanded(
                            flex: 1,
                            child: ElevatedButton(
                              onPressed: () => showAcceptDialog(context, controller),
